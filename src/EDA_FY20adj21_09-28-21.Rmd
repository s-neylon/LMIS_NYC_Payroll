...
Trying to determine if employee hours cluster around certain points - trying to find a good break point for part time vs full time.

```{r eval=FALSE}

rec_spec <- nyc_data %>% filter(title == "RECREATION SPECIALIST") 

hist(rec_spec$reg_hours, breaks= c(0, 500, 1000, 1500, 1700, 1800, 1900))
